...
class ProcessMonitor:
    ...
    def _monitor_process_output(self, process_handle: subprocess.Popen,
        ...
        while True:
            ...
            # End loop if max iterations without new data is reached
            if no_new_data_counter >= max_iterations_without_new_data:
                self._result.reached_buffer_read_timeout = True
                break
